        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <!-- <hr class="my-12"> -->
                <div class="card">
                    <h5 class="card-header"> All assigned leads are listed below</h5>
                    <div class="table-responsive text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                    ...
                                    <td>
                                        <a class="dropdown-item waves-effect" href="view_leads_for_assigned_SE.php?assign_leads_id=<?php echo $row1["assign_leads_id"]; ?>"><i class="ri-eye-line me-1"></i> </a>
                                    </td>
                            </tr>
                            <?php $i++; } ?>
                        </tbody>
                ...
                <div class="modal-dialog modal-simple modal-enable-otp modal-dialog-centered">
                  <div class="modal-content">
                    ...
                    <div class="modal-body p-0">
                      ...
                      <form id="enableOTPForm" action="suspend_property.php" method="POST">
