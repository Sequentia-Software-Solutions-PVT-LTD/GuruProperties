                    ...
                    <div class="table-responsive text-nowrap">
                        ...
                        <tbody>
                            <?php 
                                ...
                                $sql = "SELECT * FROM assign_leads WHERE admin_id = $admin_id AND status = 'Active' And transfer_status='Available' And mark_dead='' AND connection_status = 'not_connected' AND DATE(added_on) < '$today_date'";
                                $q = $pdo->query($sql);
                                // print_r($sql);
                                // exit();
