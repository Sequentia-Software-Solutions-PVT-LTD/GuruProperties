...
<html
  ...
  <head>
    ...
    <title> Transferred To CE Leads Report - SE  |  Guru Properties</title>
                ...
                <table class="datatables-users table dataTable no-footer dtr-column">
                    <thead>
                        <tr>
                            ...
                            <th>Transferred To CE</th>
                            <!-- <th>Transferred To SE</th> -->
                    ...
                    <tbody>
                        ...
                        <?php
                            $columns = "Year,Month,Transferred To CE";
                            $filename = "Report_Transferred_Leads_SE_To_CE_";
