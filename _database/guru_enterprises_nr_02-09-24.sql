...
(48, 'CE-diya', 'diya', '$2y$10$YKbPrKULwTYvlfEp0BF/f.pTrMF2CzFyrTY8Io82HIGuYvOv1ysJS', 'CUSTOMER EXECUTIVE', 'CUSTOMER EXECUTIVE', 'default.png', 'Active', 'Wagholi');
...
(10, 40, 'amol', 'amol', 'Employee', '98989898', 'seqtest@demo.com', '$2y$10$lXYWzJnqeEVgv6BY90LCDe5hCCCF3Ge8m8eFb9JweVckp8hY2JkZa', '2024-08-11 14-08-24', 'Active', 'default.png', 'CUSTOMER EXECUTIVE', '', '0000-00-00 00:00:00', '', NULL),
(11, 41, 'gayatri kate 11', 'gayatri', 'Employee', '9000099', 'gggg11@demo.com', '$2y$10$lXYWzJnqeEVgv6BY90LCDe5hCCCF3Ge8m8eFb9JweVckp8hY2JkZa', '2024-08-11 14-08-43', 'Active', 'default.png', 'SALES EXECUTIVE', '', '0000-00-00 00:00:00', '', NULL),
(12, 42, 'mayuri', 'mayuri', 'Employee', '787878787111', 'amolsir@demo.com', '$2y$10$jv9cSkYzY.Ku3If1rCAFZucpXlaAsyZeCHdVWxOI/fzcoRQ6o/Obe', '2024-08-11 14-39-20', 'Suspended', 'default.png', 'CUSTOMER EXECUTIVE', '', '2024-08-11 14:51:19', '', NULL),
(13, 43, 'megha', 'SE-megha', 'Employee', '98989891', 'amolsir1@demo.com', '$2y$10$hho1Dyc3.eR.n2g/acrYEuK/zibMM1hSyIm7qqZpvtzf9FtrHAvFi', '2024-08-11 16-03-02', 'Active', 'default.png', 'SALES EXECUTIVE', '', '0000-00-00 00:00:00', '', NULL),
(14, 44, 'pooja', 'SE-pooja', 'Employee', '9898798798', 'amolsir@demo.com', '$2y$10$MwrW090p.qd5QDDcUNM8yuY73dI65H86YZwoIoCWi5diOQtQYDpse', '2024-08-11 16-18-04', 'Active', 'default.png', 'SALES EXECUTIVE', '', '0000-00-00 00:00:00', '', NULL),
(15, 45, 'sara', 'CE-sara', 'Employee', '9898989856', 'seq1@demo.com', '$2y$10$ADI5RKEUu6S4zlbrEIAOEeTUcszIAfX1pPFd1yOKKGV.auDBN9amq', '2024-08-12 11-51-01', 'Active', 'default.png', 'CUSTOMER EXECUTIVE', '', '0000-00-00 00:00:00', '', NULL),
(16, 46, 'Lead Generator', 'leadgenerator', 'Employee', '9898989898', 'leadgenerator@gamil.com', '$2y$10$ADI5RKEUu6S4zlbrEIAOEeTUcszIAfX1pPFd1yOKKGV.auDBN9amq', '2024-08-29 23-28-06', 'Active', 'default.png', 'LEAD GENERATOR', '', '0000-00-00 00:00:00', '', NULL),
(17, 48, 'CE-diya', 'diya', 'Employee', '9898989857', 'diya@gmail.com', '$2y$10$YKbPrKULwTYvlfEp0BF/f.pTrMF2CzFyrTY8Io82HIGuYvOv1ysJS', '2024-09-02 15-21-25', 'Active', 'default.png', 'CUSTOMER EXECUTIVE', '', '2024-09-02 15:46:43', 'Wagholi', 15);
...
INSERT INTO `property_name` (`property_name_id`, `property_title`, `location`, `location_id`, `google_location_lat`, `google_location_long`, `builder_name`, `added_on`, `edited_on`, `pdf1`, `pdf2`, `pdf3`, `pdf4`, `pdf5`, `pdf6`, `video1`, `video2`, `video3`, `video4`) VALUES
(1, 'Mehta Properties', 'Baner', NULL, NULL, NULL, 'Sagar Mehta', '2024-08-22 18:05:06', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 'Sharma Properties', 'Wakad', NULL, NULL, NULL, 'Pooja Sharma', '2024-08-22 18:05:51', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, 'Sighania Properties', 'Viman Nagar', NULL, NULL, NULL, 'Ashok Sighania', '2024-08-22 18:06:47', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, 'Raunak Group', 'Sangavi', NULL, NULL, NULL, 'Shreya Raunak', '2024-08-22 18:17:24', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(5, 'Shaha Property', 'Wagholi', 15, '0.7878', '0.2323', 'Amol Shaha', '2024-09-02 17:42:01', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(6, 'Joshi Property', 'Shivaji Nagar', 8, '0.343', '0.454', 'Sarang Joshi', '2024-09-02 18:56:51', '0000-00-00 00:00:00', 'uploads/pdfs/The Tactics -2.pdf', 'uploads/pdfs/Advanced beginners_April 2018 (1).pdf', 'uploads/pdfs/Double Attack (1).pdf', NULL, NULL, NULL, 'uploads/videos/skinsure-screenrecord.webm', 'uploads/videos/3.edit_bill.webm', NULL, NULL);
...
--
ALTER TABLE `employee`
  MODIFY `employee_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `property_name`
  MODIFY `property_name_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
