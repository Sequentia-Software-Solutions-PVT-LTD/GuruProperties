                ...
                <div class="card">
                    ...
                    <div class="table-responsive text-nowrap">
                        ...
                        <tbody>
                            <?php 
                                $i = 1;
                                $sql = "SELECT * FROM assign_leads where admin_id= $admin_id and status = 'From SE' and transfer_status='Available' and transfer_employee_type = 'SALES EXECUTIVE' and mark_dead=''";
                                // $sql = "SELECT * FROM assign_leads where admin_id= $admin_id and status = 'Followup' and transfer_status='Available' and mark_dead=''";
                                // $sql = "SELECT * FROM assign_leads where admin_id= $admin_id and status='Active' ";
                                $q = $pdo->query($sql);
                                // print_r($sql);
