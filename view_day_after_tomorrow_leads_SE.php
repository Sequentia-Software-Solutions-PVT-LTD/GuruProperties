...
<html
  ...
  <head>
    ...
    <title>View Day After Tomorrow's Leads |  Guru Properties</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <!-- <hr class="my-12"> -->
                <div class="card">
                    <h5 class="card-header"> All Day After Tomorrow's Leads are listed bellow</h5>
                    <div class="table-responsive text-nowrap">
                        ...
                        <tbody>
                            <?php 
                                ...
                                $sql = "SELECT * FROM assign_leads_sr where admin_id= $admin_id and DATE(visit_date) = '$tomorrow_date'";
                                $q = $pdo->query($sql);
                                // print_r($sql);
                                // exit();
