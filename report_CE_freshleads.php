...
//   $sql_query = "SELECT * from assign_leads WHERE status='Active'";
...
<html
  ...
  <head>
    ...
    <title> Received Leads Report - CE  |  Guru Properties</title>
              ...
              <form method="POST" action="#" enctype="multipart/form-data">
                ...
                <table class="datatables-users table dataTable no-footer dtr-column">
                    ...
                    <tbody>
                        ...
                        <?php
                            $columns = "Year,Month,Received Leads";
                            $filename = "Report_Fresh_Leads_CE_";
