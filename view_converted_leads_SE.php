...
<html
  ...
  <head>
    ...
    <title>View All Converted Leads |  Guru Properties</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <!-- <hr class="my-12"> -->
                <div class="card">
                    <h5 class="card-header"> All Converted Leads are listed bellow</h5>
                    <div class="table-responsive text-nowrap">
                        ...
                        <tbody>
                            <?php 
                                ...
                                $sql = "SELECT * FROM assign_leads_sr where admin_id= $admin_id and status='Converted'";
                                $q = $pdo->query($sql);
                                // print_r($sql);
                                // exit();
