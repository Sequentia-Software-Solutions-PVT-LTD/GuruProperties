...
<html
  ...
  <head>
    ...
    <title> View Upcoming Visits |  Guru Properties</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <!-- <hr class="my-12"> -->
                <div class="card">
                    <h5 class="card-header"> All Upcoming Visits are listed below</h5>
                    <div class="table-responsive text-nowrap">
                        ...
                        <tbody>
                            <?php 
                                ...
                                // $sql = "SELECT * FROM assign_leads_sr WHERE admin_id = $admin_id  AND DATE(visit_date) > '$today_date'";
                                $sql = "SELECT * FROM assign_leads_sr WHERE admin_id = $admin_id  AND DATE(visit_date) > '$today_date' And status = 'Active' And transfer_status = 'Available'";
                                $q = $pdo->query($sql);
                                // print_r($sql);
                                // exit();
