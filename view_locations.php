                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu"> -->
                                                ...
                                                <a class="dropdown-item waves-effect open-myModal" data-bs-toggle="modal" data-bs-target="#enableOTP" data-id="<?php echo $row["id"]; ?>"><i class="ri-delete-bin-7-line me-1"></i> </a>
                                            <!-- </div> -->
                                        </div>
                                    </td>
                            </tr>
