        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <!-- <hr class="my-12"> -->
                <div class="card">
                    <h5 class="card-header"> All transfered leads are listed bellow</h5>
                    <div class="table-responsive text-nowrap">
                        ...
                        <tbody>
                            <?php 
                                ...
                                $sql = "SELECT * FROM assign_leads where admin_id= $admin_id and status='Active' and transfer_status='Trasnfered' and mark_dead=''";
                                // $sql = "SELECT * FROM assign_leads WHERE admin_id = $admin_id AND mark_dead = 'Yes'";
                                $q = $pdo->query($sql);
                                // print_r($sql);
                                // exit();
