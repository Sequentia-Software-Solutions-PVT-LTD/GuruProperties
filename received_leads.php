        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <!-- <hr class="my-12"> -->
                <div class="card">
                    <h5 class="card-header"> All Recieved Leads from Customer Executive are listed below</h5>
                        ...
                        <tbody>
                            <?php 
                                ...
                                { 
                                    ...
                                    // $sqlasnl = "select * from assign_leads where admin_id = $admin_id and status = 'Transfered' and transfer_status = 'Not Available'  ";
                            ...
                            <tr>
                                    ...
                                    <td>
                                        <?php 
                                            $status_next_date = date('Y-m-d', strtotime($row1["next_date"]));
                                            if($status_next_date > date('Y-m-d'))
                                            {
                                              echo "<span class='text-danger'>";
                                            }
                                            echo date('d-m-Y', strtotime($row1["next_date"])); 
                                            echo "</span>";
                                          ?>
                                    </td>
                                    <td>
                ...
                <div class="card">
                    ...
                    <div class="table-responsive text-nowrap">
                        ...
                        <tbody>
                            <?php 
                                $i = 1;
                                $sql = "SELECT * FROM assign_leads where admin_id = $admin_id and status = 'From SE' and transfer_status='Available' and mark_dead=''";
                                // $sql = "SELECT * FROM assign_leads where admin_id= $admin_id and status = 'Followup' and transfer_status='Available' and mark_dead=''";
                                // $sql = "SELECT * FROM assign_leads where admin_id= $admin_id and status='Active' ";
                                $q = $pdo->query($sql);
                                // print_r($sql);
