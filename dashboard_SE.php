...
$sql_total = "SELECT COUNT(assign_leads_sr_id)  AS total_count
...
$sql_connected = "SELECT COUNT(assign_leads_sr_id)  AS total_count_connected
              FROM assign_leads_sr 
...
// echo "<pre>";
// print_r($sql_connected);
// print_r($row_total_connected);
// exit();
// -------------------------- Total Not-Connected leads count -----------------------------------------------------------
$sql_notconnected = "SELECT COUNT(assign_leads_sr_id)  AS total_count_notconnected
              FROM assign_leads_sr 
...
// echo "<pre>";
// print_r($sql_notconnected);
// print_r($row_total_notconnected);
// exit();
// -------------------------- Total Transferred leads count -----------------------------------------------------------
$sql_transferred = "SELECT COUNT(assign_leads_sr_id)  AS total_count_transferred
              FROM assign_leads_sr 
              WHERE status = 'Active' And transfer_status = 'Transferred'
              AND admin_id = $admin_id 
              AND YEAR(added_on) = YEAR(CURRENT_DATE - INTERVAL 1 MONTH)
              AND MONTH(added_on) = MONTH(CURRENT_DATE - INTERVAL 1 MONTH)
            ";
...
// $sql_assigned = "SELECT COUNT(assign_leads_sr_id)  AS total_count_assigned
//               FROM assign_leads_sr 
...
// -------------------------- Total Converted leads count -----------------------------------------------------------

$sql_convert = "SELECT COUNT(assign_leads_sr_id)  AS total_count_converted
              FROM assign_leads_sr 
...
$qtotalconvert = $pdo->prepare($sql_convert);
$qtotalconvert->execute();
$row_total_convert = $qtotalconvert->fetch(PDO::FETCH_ASSOC);

$total_assigned_leads = $row_total_convert['total_count_converted'];


// -------------------------- Total Dead leads count -----------------------------------------------------------
$sql_dead = "SELECT COUNT(assign_leads_sr_id)  AS total_count_dead
              FROM assign_leads_sr 
              WHERE status = 'Dead' 
              AND admin_id = $admin_id 
              AND YEAR(added_on) = YEAR(CURRENT_DATE - INTERVAL 1 MONTH)
...
$sql_combined = "
    SELECT 
        COUNT(CASE WHEN status = 'Active' AND DATE(added_on) = DATE_SUB(CURDATE(), INTERVAL 1 DAY) THEN 1 END) AS total_fresh_leads_y,
        ...
        COUNT(CASE WHEN status = 'Converted' AND DATE(added_on) = DATE_SUB(CURDATE(), INTERVAL 1 DAY) THEN 1 END) AS total_assigned_leads_y,
...
$sql_fc = "SELECT COUNT(assign_leads_sr_id)  AS total_count_fresh
              FROM assign_leads_sr 
              WHERE status = 'Active' 
              AND admin_id = $admin_id ";
...
// -----------------------------------------------------------
$sql_ac = "SELECT COUNT(assign_leads_sr_id)  AS total_count_AC
              FROM assign_leads_sr 
              WHERE status = 'Converted' 
              AND admin_id = $admin_id ";
