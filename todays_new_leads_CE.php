...
<html
  ...
  <head>
    ...
    <title>View Today's Leads |  Guru Properties</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <!-- <hr class="my-12"> -->
                <div class="card">
                    <h5 class="card-header"> All today's leads are listed bellow</h5>
                    <div class="table-responsive text-nowrap">
                        ...
                        <tbody>
                            <?php 
                                ...
                                $sql = "SELECT * FROM assign_leads WHERE admin_id = $admin_id AND status = 'Active' And transfer_status='Available' AND DATE(added_on) = '$today_date'";
                                $q = $pdo->query($sql);
                                // print_r($sql);
                                // exit();
