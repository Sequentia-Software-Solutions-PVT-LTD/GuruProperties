<?php
    ...
    $TOmonth = "12";
    $overallCommision = 0;
    $sql = "SELECT *, month(`added_on`) as Month, YEAR(`added_on`) as Year FROM converted_leads WHERE month(`added_on`) >= '$Frommonth' and month(`added_on`) <= '$TOmonth' and YEAR(`added_on`) = '$year'";
