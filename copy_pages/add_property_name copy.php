...
if (isset($_POST["submit"])) { 
    ...
    try {
        ...
        $sql = "INSERT INTO `property_name`(`property_title`, `location`, `builder_name`,`status`, `added_on`, `location_id`, `google_location_lat`, `google_location_long`, `pdf1`, `pdf2`, `pdf3`, `pdf4`, `pdf5`, `pdf6`, `video1`, `video2`, `video3`, `video4`) 
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        $q = $pdo->prepare($sql);
        $q->execute([
